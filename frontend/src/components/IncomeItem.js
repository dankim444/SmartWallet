...
import { bitcoin, book, card, circle, clothing, food, freelance, medical, money, piggy, stocks, takeaway, tv, users, yt, calendar, comment, dollar, trash } from '../utils/icons'

// component that shows the income items to the right of the income form
const IncomeItem = ({
    id,
    title,
    amount,
    ...
    // function that switches icons based on income category
    ...
    // switches icons based on expense category
